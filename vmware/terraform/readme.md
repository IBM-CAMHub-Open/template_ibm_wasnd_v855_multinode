# Template - IBM WebSphere Application Server Network Deployment V8.5.5 cell with IBM HTTP Server
Template Version - 1.0

## Description

This template deploys a WebSphere Application Server Network Deployment V8.5.5 cell with an integrated IBM HTTP Server.<br>
